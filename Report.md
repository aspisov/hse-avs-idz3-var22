# Отчет по ИДЗ №3
### Вариант 22, Асписов Дмитрий Алексеевич БПИ218
 
 
### Код на C на 6 баллов
```c
#include <stdio.h>
#include <math.h>
...
```sh
gcc -masm=intel -S main3.c -o 1.s
```

### Удаление макросов при помощи флага
```sh
gcc -O0 -Wall -masm=intel -S -fno-asynchronous-unwind-tables -fcf-protection=none main3.c -o 2.s
```
...
| Входные данные  | 1.s            | 2.s           |
|-----------------|:---------------:|:---------------:|
| 0.001 | 3.140593 | 3.140593 |
| 0.0007  | 3.140893  |3.140893  |
| 0.000001   | 3.141592 | 3.141592|
...
### Рефакторинг
Рефакторинг программы проведён за счёт использования регистров, 
cокращены ненужные переносы из одного регистра в другой, 
добавлены комментарии, поясняющие изменения.
```assembly
	.file	"main3.c"
	.intel_syntax noprefix
	.text
